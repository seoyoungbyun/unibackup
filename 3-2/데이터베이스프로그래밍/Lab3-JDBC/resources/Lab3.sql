DROP TABLE DEPT0769 CASCADE CONSTRAINTS;
DROP TABLE EMP0769 CASCADE CONSTRAINTS;

CREATE TABLE DEPT0769 (
...
CREATE TABLE EMP0769 (
	...
	SAL NUMBER(7,2),
	COMM NUMBER(7,2),
	DEPTNO NUMBER(2) REFERENCES DEPT0769(DEPTNO)
);

INSERT INTO DEPT0769 VALUES
...
ALTER TABLE DEPT0769 ADD CONSTRAINT FK_DEPT0769 
	FOREIGN KEY(MANAGER) REFERENCES EMP0769(EMPNO);
