	    ...
	    <table>
	        ...
	        <tr>
	            ...
	            <th width = 200 style="border: 2px solid #f0f0f0;">
	            	...
	            	<input type = text value = <jsp:getProperty name="calc" property="op1"/> name = op1 style="text-align:center;width:100px;" readonly>
	            	<br><br>
	            	<jsp:getProperty name="calc" property="operator"/>
	            	<p>
	            	<input type = text value = <jsp:getProperty name="calc" property="op2"/> name = op1 style="text-align:center;width:100px;" readonly>
	            	<br><br>
	            	=
	            	<p>
	            	<%
